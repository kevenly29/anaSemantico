...
namespace analizadorLexico
{
    ...
    class Compilador
    {
        ...
        public void cargarMatriz()
        {
            ...
            String[] lineas = File.ReadAllLines(@"C:\Users\keven\Downloads\AnalizadorSemantico-main\AnalizadorSemantico-main\analizadorLexico\compilador.lr", Encoding.Default);
        ...
        public void cargarReglas()
        {
            int delimitador = 9;
            char _dem = Convert.ToChar(delimitador);
            string[] lineas = File.ReadAllLines(@"C:\Users\keven\Downloads\AnalizadorSemantico-main\AnalizadorSemantico-main\analizadorLexico\reglas.txt", Encoding.Default);
